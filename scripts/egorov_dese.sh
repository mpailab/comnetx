...
NAME=""
DOCKER=docker
# Используем тот же базовый образ, так как он подходит для CUDA 11.8
...
# Обратите внимание: пути -v (volume) оставлены как в примере. 
# Убедитесь, что папки /auto/datasets/graphs существуют на вашей машине.
...
echo "[INFO] All Python packages installed successfully."