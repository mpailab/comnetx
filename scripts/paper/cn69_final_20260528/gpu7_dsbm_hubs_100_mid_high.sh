...
run_dsbm "DSBM hubs 100 batches mid/high mc2900" "gpu7_dsbm_hubs_100_batches_mid_high_mc2900" \
  --root "$DSBM_ROOT" \
  --batch-suffix 100_batches \
  --regimes hubs \
  --max-changes 2900

run_dsbm "DSBM hubs 100 batches mid/high mc14500" "gpu7_dsbm_hubs_100_batches_mid_high_mc14500" \
  --root "$DSBM_ROOT" \
  --batch-suffix 100_batches \
  --regimes hubs \
  --max-changes 14500

run_dsbm "DSBM hubs 100 batches mid/high mc29000" "gpu7_dsbm_hubs_100_batches_mid_high_mc29000" \
  --root "$DSBM_ROOT" \
  --batch-suffix 100_batches \
  --regimes hubs \
  --max-changes 29000
