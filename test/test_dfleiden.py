...
def test_dfleiden_partition_basic():
    ...
    timing_info = {}
    labels = _run_or_skip(lambda: dfleiden_partition(adj, timing_info=timing_info))
...
def test_optimizer_dfleiden_branch():
    ...
    opt = Optimizer(adj, features=features, method="dfleiden")
...
def test_dfleiden_on_cora():
    ...
    new_labels = _run_or_skip(lambda: dfleiden_partition(adj))
