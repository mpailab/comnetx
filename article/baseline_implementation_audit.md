...
- DynaMo: public sample repository `https://github.com/nogrady/dynamo`; tnetwork
  external wrapper documentation
  `https://tnetwork.readthedocs.io/en/latest/reference/generated/tnetwork.DCD.externals.dynamo.html`.
- ALPA: PLOS ONE paper notes a Julia implementation at
  `https://github.com/afternone/ALPA.jl`.
- tnetwork DCD: `https://tnetwork.readthedocs.io/en/latest/reference/DCD.html`.
- CDlib temporal clustering:
  `https://cdlib.readthedocs.io/en/v0.2.1/reference/cd_algorithms/temporal_clustering.html`.
- DF-Louvain: `https://pypi.org/project/df-louvain/`.
- DynComm: `https://rdrr.io/cran/DynComm/`.
- NetworKit community detection:
  `https://networkit.github.io/dev-docs/notebooks/Community.html`.
- OLCPM project page: `https://olcpm.sci-web.net/`.
- Sattar et al. DyComPar/DyG-DPCD line:
  `https://www.ornl.gov/publication/exploring-temporal-community-evolution-algorithmic-approaches-and-parallel-optimization`
  and `https://link.springer.com/article/10.1007/s41109-023-00592-1`.
