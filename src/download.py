...
DATASETS_PATH = os.getenv("COMNETX_DATASETS_PATH", "/workspace/datasets")
...
def download_attr_graph(name: str, save_path: str = DATASETS_PATH):
    dname = name.lower()
    root = os.path.join(DATASETS_PATH, "torch_geom_datasets", dname)
    if dname == "flickr":
...
def download_ogb_graph(name: str, save_path: str = DATASETS_PATH):
    ...
    ogb_root = os.path.join(DATASETS_PATH, "ogb")
...
def download_tgc_graph(name: str, save_path: str = DATASETS_PATH):
    ...
    data_dir = os.path.join(DATASETS_PATH, "tgc_raw")
    save_path = os.path.join(DATASETS_PATH, "tgc")
